        ...
        <div class="x-searchform-overlay-inner">
          <div class="x-container max width">
            <form method="get" id="searchform" class="form-search center-text" action="<?php echo esc_url( home_url( '/' ) ); ?>">
              <label for="s" class="cfc-h-tx tt-upper"><?php _e( 'Digite e presione &ldquo;enter&rdquo; para buscar', '__x__' ); ?></label>
      ...
      if ( $args->theme_location == 'primary' ) {
        $items .= '<li class="menu-item x-menu-item x-menu-item-search">'
                  . '<a href="#" class="x-btn-navbar-search">'
                    . '<span><i class="x-icon-search" data-x-icon="&#xf002;"></i><span class="x-hidden-desktop"> ' . __( 'Buscar', '__x__' ) . '</span></span>'
                  . '</a>'
                . '</li>';
      }
    }
