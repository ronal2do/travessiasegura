      ...
      <ul class="option-set unstyled" data-option-key="filter">
        <li>
          ...
          <ul class="x-portfolio-filters-menu unstyled">
            <li><a href="#" data-option-value="*" class="x-portfolio-filter selected"><?php _e( 'Tudo', '__x__' ); ?></a></li>
      ...
      <ul class="option-set unstyled" data-option-key="filter">
        <li>
          <a href="#" class="x-portfolio-filters cf">
            <span class="x-portfolio-filter-label"><?php _e( 'Fitrar', '__x__' ); ?></span>
...
function x_portfolio_item_project_link() {
  ...
  $launch_title  = x_get_option( 'x_portfolio_launch_project_title', __( 'Ver', '__x__' ) );
  $launch_button = x_get_option( 'x_portfolio_launch_project_button_text', __( 'Ver', '__x__' ) );
...
function x_portfolio_item_social() {
  ...
  $share_project_title = x_get_option( 'x_portfolio_share_project_title', __( 'Compartilhe isto', '__x__' ) );
